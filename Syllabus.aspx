       ...
       <table align="center" >
        ...
        <tr>
            ...
            <td>            <asp:TextBox ID="UnitTextBox" CssClass="TextB" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator ID="un_val" runat="server" ControlToValidate="UnitTextBox" Display="Dynamic" ErrorMessage="Field Required!"></asp:RequiredFieldValidator>
</td>
        </tr>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="id_val" runat="server" ControlToValidate="TopicidTextBox" Display="Dynamic" ErrorMessage="Field Required!"></asp:RequiredFieldValidator>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="nm_val" runat="server" ControlToValidate="TopicNameTextBox" Display="Dynamic" ErrorMessage="Filed Required!"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td colspan="2">
