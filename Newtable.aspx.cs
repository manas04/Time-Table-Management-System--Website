    ...
    protected void b1_Click(object sender, EventArgs e)
    {
        ...
        if (dyear.SelectedValue == "First" && dsem.SelectedValue == "YearlyPattern")
        {
            if (dbranch.SelectedValue == "CSE")
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("insert into tt.OneCseA values('" + ddDay.SelectedValue + "','" + ddPeriod.SelectedValue + "','" + lbTimeFrom.Text + "','" + lbTimeTo.Text + "','" + ddSub.SelectedValue + "',(select Faculty_Name from tt.FacOneCseA where (Subject_Name = '" + ddSub.SelectedValue + "')),'" + classType.SelectedValue + "')", con);
                    cmd.ExecuteNonQuery();
                }
                else if (dsection.SelectedValue == "B")
                {
                    SqlCommand cmd = new SqlCommand("insert into tt.OneCseB values('" + ddDay.SelectedValue + "','" + ddPeriod.SelectedValue + "','" + lbTimeFrom.Text + "','" + lbTimeTo.Text + "','" + ddSub.SelectedValue + "',(select Faculty_Name from tt.FacOneCseB where (Subject_Name = '" + ddSub.SelectedValue + "')),'" + classType.SelectedValue + "')", con);
                    cmd.ExecuteNonQuery();
                }
                else if (dsection.SelectedValue == "C")
                {
                    SqlCommand cmd = new SqlCommand("insert into tt.OneCseC values('" + ddDay.SelectedValue + "','" + ddPeriod.SelectedValue + "','" + lbTimeFrom.Text + "','" + lbTimeTo.Text + "','" + ddSub.SelectedValue + "',(select Faculty_Name from tt.FacOneCseC where (Subject_Name = '" + ddSub.SelectedValue + "')),'" + classType.SelectedValue + "')", con);
                    cmd.ExecuteNonQuery();
                }
                else if (dsection.SelectedValue == "D")
                {
                    SqlCommand cmd = new SqlCommand("insert into tt.OneCseD values('" + ddDay.SelectedValue + "','" + ddPeriod.SelectedValue + "','" + lbTimeFrom.Text + "','" + lbTimeTo.Text + "','" + ddSub.SelectedValue + "',(select Faculty_Name from tt.FacOneCseD where (Subject_Name = '" + ddSub.SelectedValue + "')),'" + classType.SelectedValue + "')", con);
                    cmd.ExecuteNonQuery();
                }
                else if (dsection.SelectedValue == "E")
                {
                    SqlCommand cmd = new SqlCommand("insert into tt.OneCseE values('" + ddDay.SelectedValue + "','" + ddPeriod.SelectedValue + "','" + lbTimeFrom.Text + "','" + lbTimeTo.Text + "','" + ddSub.SelectedValue + "',(select Faculty_Name from tt.FacOneCseE where (Subject_Name = '" + ddSub.SelectedValue + "')),'" + classType.SelectedValue + "')", con);
                    cmd.ExecuteNonQuery();
                }
                else if (dsection.SelectedValue == "F")
                {
                    SqlCommand cmd = new SqlCommand("insert into tt.OneCseF values('" + ddDay.SelectedValue + "','" + ddPeriod.SelectedValue + "','" + lbTimeFrom.Text + "','" + lbTimeTo.Text + "','" + ddSub.SelectedValue + "',(select Faculty_Name from tt.FacOneCseF where (Subject_Name = '" + ddSub.SelectedValue + "')),'" + classType.SelectedValue + "')", con);
                    cmd.ExecuteNonQuery();
                }
                else if (dsection.SelectedValue == "G")
                {
                    SqlCommand cmd = new SqlCommand("insert into tt.OneCseG values('" + ddDay.SelectedValue + "','" + ddPeriod.SelectedValue + "','" + lbTimeFrom.Text + "','" + lbTimeTo.Text + "','" + ddSub.SelectedValue + "',(select Faculty_Name from tt.FacOneCseG where (Subject_Name = '" + ddSub.SelectedValue + "')),'" + classType.SelectedValue + "')", con);
                    cmd.ExecuteNonQuery();
                }
            ...
            else if (dbranch.SelectedValue == "ECE")
            {
                if (dsection.SelectedValue == "A")
                {
                    SqlCommand cmd = new SqlCommand("insert into tt.OneEceA values('" + ddDay.SelectedValue + "','" + ddPeriod.SelectedValue + "','" + lbTimeFrom.Text + "','" + lbTimeTo.Text + "','" + ddSub.SelectedValue + "',(select Faculty_Name from tt.FacOneEceA where (Subject_Name = '" + ddSub.SelectedValue + "')),'" + classType.SelectedValue + "')", con);
                    cmd.ExecuteNonQuery();
                }
                else if (dsection.SelectedValue == "B")
                {
                    SqlCommand cmd = new SqlCommand("insert into tt.OneEceB values('" + ddDay.SelectedValue + "','" + ddPeriod.SelectedValue + "','" + lbTimeFrom.Text + "','" + lbTimeTo.Text + "','" + ddSub.SelectedValue + "',(select Faculty_Name from tt.FacOneEceB where (Subject_Name = '" + ddSub.SelectedValue + "')),'" + classType.SelectedValue + "')", con);
                    cmd.ExecuteNonQuery();
                }
            }
            else if (dbranch.SelectedValue == "IT")
            {
                SqlCommand cmd = new SqlCommand("insert into tt.OneIt values('" + ddDay.SelectedValue + "','" + ddPeriod.SelectedValue + "','" + lbTimeFrom.Text + "','" + lbTimeTo.Text + "','" + ddSub.SelectedValue + "',(select Faculty_Name from tt.FacOneIt where (Subject_Name = '" + ddSub.SelectedValue + "')),'" + classType.SelectedValue + "')", con);
                cmd.ExecuteNonQuery();
            }
            else if (dbranch.SelectedValue == "EIE")
            {
                SqlCommand cmd = new SqlCommand("insert into tt.OneEie values('" + ddDay.SelectedValue + "','" + ddPeriod.SelectedValue + "','" + lbTimeFrom.Text + "','" + lbTimeTo.Text + "','" + ddSub.SelectedValue + "',(select Faculty_Name from tt.FacOneEie where (Subject_Name = '" + ddSub.SelectedValue + "')),'" + classType.SelectedValue + "')", con);
                cmd.ExecuteNonQuery();
            }
        }
            ...
            if (dbranch.SelectedValue == "CSE")
            {
                if (dsem.SelectedValue == "1")
                {
                    if (dsection.SelectedValue == "A")
                    {
                        ...
                        SqlCommand cmd = new SqlCommand("insert into tt.Two1CseA values('" + ddDay.SelectedValue + "','" + ddPeriod.SelectedValue + "','" + lbTimeFrom.Text + "','" + lbTimeTo.Text + "','" + ddSub.SelectedValue + "',(select Faculty_Name from tt.FacTwo1CseA where (Subject_Name = '" + ddSub.SelectedValue + "')),'" + classType.SelectedValue + "')", con);
                        cmd.ExecuteNonQuery();
                        Display(ddDay.SelectedValue, ddPeriod.SelectedValue, ddSub.SelectedValue);
                    }
                    else if (dsection.SelectedValue == "B")
                    {
                        SqlCommand cmd = new SqlCommand("insert into tt.Two1CseB values('" + ddDay.SelectedValue + "','" + ddPeriod.SelectedValue + "','" + lbTimeFrom.Text + "','" + lbTimeTo.Text + "','" + ddSub.SelectedValue + "',(select Faculty_Name from tt.FacTwo1CseB where (Subject_Name = '" + ddSub.SelectedValue + "')),'" + classType.SelectedValue + "')", con);
                        cmd.ExecuteNonQuery();
                        Display(ddDay.SelectedValue, ddPeriod.SelectedValue, ddSub.SelectedValue);
                    }
                }
                else if (dsem.SelectedValue == "2")
                {
                    if (dsection.SelectedValue == "A")
                    {                                                
                        SqlCommand cmd = new SqlCommand("insert into tt.Two2CseA values('" + ddDay.SelectedValue + "','" + ddPeriod.SelectedValue + "','" + lbTimeFrom.Text + "','" + lbTimeTo.Text + "','" + ddSub.SelectedValue + "',(select Faculty_Name from tt.FacTwo2CseA where (Subject_Name = '" + ddSub.SelectedValue + "')),'" + classType.SelectedValue + "')", con);
                        cmd.ExecuteNonQuery();
                        Display(ddDay.SelectedValue, ddPeriod.SelectedValue, ddSub.SelectedValue);
                    }
                    else if (dsection.SelectedValue == "B")
                    {                       
                        SqlCommand cmd = new SqlCommand("insert into tt.Two2CseB values('" + ddDay.SelectedValue + "','" + ddPeriod.SelectedValue + "','" + lbTimeFrom.Text + "','" + lbTimeTo.Text + "','" + ddSub.SelectedValue + "',(select Faculty_Name from tt.FacTwo2CseB where (Subject_Name = '" + ddSub.SelectedValue + "')),'" + classType.SelectedValue + "')", con);
                        cmd.ExecuteNonQuery();
                        Display(ddDay.SelectedValue, ddPeriod.SelectedValue, ddSub.SelectedValue);                        
                    }
                }
