...
public partial class Admin_FacD : System.Web.UI.Page
{
    ...
    protected void fdel_Click(object sender, EventArgs e)
    {
        con.Open();
        SqlCommand cmd = new SqlCommand("delete from fac.facultydata where (fid = '" + fid.Text + "' and fmobile = '" + fmobile.Text + "' and dept = '" + dept.Text + "')", con);
        cmd.ExecuteNonQuery();
        con.Close();
