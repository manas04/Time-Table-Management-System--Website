...
.AS{
    ...
    <table>
        ...
        <tr>
            <td>
                <asp:DropDownList ID="DropDownSub1" CssClass="Ddrop" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="SubName" DataValueField="SubName" >
       ...
       <td>
        ...
        <tr>
            <td colspan="3">
                ...
                <asp:Button ID="SubjectSubmitButton0" CssClass="AS" runat="server" Text="Finish" Height="34px" OnClick="SubjectSubmitButton0_Click" />
            </td>
        </tr>
    </table>
    <br />
